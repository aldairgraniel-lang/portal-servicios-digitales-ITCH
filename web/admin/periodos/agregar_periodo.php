        ...
        <div class="col-md-5">
            <div class="glass-card p-4 shadow-lg">
                <div class="d-flex justify-content-between align-items-center mb-4 px-2">
                    <h4 class="m-0 fw-bold">Nuevo Periodo</h4>
                    <a href="periodos.php" class="btn btn-outline-light btn-sm rounded-pill px-3">
                        <i class="bi bi-arrow-left me-1"></i> Volver
                    </a>
                </div>

                <form action="procesar_periodo.php" method="POST" class="px-2">
                    <input type="hidden" name="accion" value="agregar">
                    
                    <div class="mb-4">
                        <label class="text-white-50 small ms-1">Nombre del Periodo</label>
                        <input type="text" name="nombre" class="input-glass form-control" placeholder="Ej: AGO-DIC 2026" required>
                    </div>
