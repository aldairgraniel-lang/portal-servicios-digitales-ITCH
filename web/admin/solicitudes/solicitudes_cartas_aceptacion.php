                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <button class="btn btn-sm btn-warning text-white me-1" title="Editar" 
                                        onclick="editarAceptacion(<?= htmlspecialchars(json_encode($sol)) ?>)">
...
<div class="modal fade" id="modalAceptacion" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content bg-dark text-white border border-secondary">
            <div class="modal-header border-secondary">
                <h5 class="modal-title" id="modalTitleAceptacion">Nueva Solicitud</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="formAceptacion" action="procesar_cartas_aceptacion.php" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    <input type="hidden" name="accion" id="accionAceptacion" value="guardar">
                    <input type="hidden" name="id" id="aceptacion_id" value="">
...
function limpiarAceptacion() {
    ...
    document.getElementById('accionAceptacion').value = 'guardar';
    document.getElementById('aceptacion_id').value = '';
    document.getElementById('modalTitleAceptacion').innerText = 'Nueva Solicitud';
}

function editarAceptacion(sol) {
