...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Si el tipo es Egresado, el semestre se guarda como NULL, si no, se guarda el valor del select
    $semestre = (!empty($_POST['semestre'])) ? $conexion->real_escape_string($_POST['semestre']) : "NULL";

    // Consulta SQL actualizada
    // Nota: Si $semestre es NULL, no ponemos comillas, si tiene valor, usamos el valor
