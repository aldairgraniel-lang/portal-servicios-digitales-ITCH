...
<style>
    ...
    .contenedor-form { width: 100%; max-width: 800px; margin: auto; }
    .card-registro { background: #ffffff; border-top: 8px solid #9D843E; border-radius: 15px; box-shadow: 0 10px 25px rgba(0,0,0,0.1); padding: 2rem; }
    .label-tecnm { color: #1B396A; font-weight: 700; font-size: 0.9rem; margin-bottom: 5px; display: block; }
