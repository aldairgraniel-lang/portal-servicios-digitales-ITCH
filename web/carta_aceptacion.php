...
<style>
    ...
    .estado-cerrado { text-align: center; padding: 40px; }
    .display-1 { font-size: 4rem; margin-bottom: 1rem; }
    .titulo-cerrado { color: #1B396A; font-weight: 800; }
</style>
...
<div class="container py-5">
    <div class="row justify-content-center">
        <div class="col-md-7">
            ...
            <?php if ($estado !== '1'): ?>
                <div class="card-registro estado-cerrado">
                    <div class="display-1">⚠️</div>
                    <h2 class="titulo-cerrado">TRÁMITE CERRADO</h2>
                    <p class="text-muted mt-3">El registro de carta de aceptación no está disponible actualmente.</p>
